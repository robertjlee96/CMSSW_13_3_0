...
lcg_PyCoral_LOC_FLAGS_CXXFLAGS   := -fpermissive -Wno-unknown-pragmas
lcg_PyCoral_EX_USE := $(foreach d, coral   LCG/RelationalAccess python3 ,$(if $($(d)_EX_FLAGS_NO_RECURSIVE_EXPORT),,$d))
